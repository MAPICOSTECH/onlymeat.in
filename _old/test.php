  	...
  	<div class="container">
  		<div class="form_prt_innr">
  			...
  			<div class="from_sec" id="your-order">
        	     ...
        	     <td class="cl2"  id="con6"><?php echo $_REQUEST["quantity6"]?> Kg</td>
        	      ...
        	      <td class="cl2">&#8377; 25</td>
  					...
  					<div class="table_last_prt">
  						...
  						<div class="rad">
  						<input type="radio" name="deliverytime" checked value="1" />
  						Delivery Now
  						</div>
  						<div class="rad">
  						<input type="radio" name="deliverytime" value="2" />
  						Scheduled Delivery
  						</div>
                ...
                <input type="login" name="submit" id="f_login" value="Login" style="align:left width:100px;">
                </div>
  							...
  							<div class="form_1 ccfield-prepend newu">
  								...
  								<input type="text" required name="mobile_number" id="mobile_number1" placeholder="Mobile Number / Landline" >
  							</div>
